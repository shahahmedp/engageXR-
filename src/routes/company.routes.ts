...
module.exports = function (app: any) {
  ...
  app.post(
    ...
    (req: Request, res: Response, next: NextFunction) => {
      ...
      if (!errors.isEmpty()) {
        res
          ...
          .json({ status: dailogue.code404.message, message: errors })
      } else {
        next()
      }
    },
    [
      ...
      Authjwt.VerifyToken,
      Authjwt.isCompany,
      VerifyCompany.checkDuplicatCMPNameCMPemail,
    ],
    //controllers
    ...
    (req: Request, res: Response, next: NextFunction) => {
      ...
      if (!errors.isEmpty()) {
        res
          ...
          .json({ status: dailogue.code400.message, message: errors })
      } else {
        next()
      }
    },
